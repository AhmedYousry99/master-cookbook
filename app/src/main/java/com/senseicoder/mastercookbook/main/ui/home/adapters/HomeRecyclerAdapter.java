...
import com.senseicoder.mastercookbook.main.ui.home.HomeFragmentItem;
...
class MainHeaderViewHolder extends  BaseViewHolder{
    ...
    public MainHeaderViewHolder(@NonNull View itemView) {
        super(itemView);
        this.homeListTilecardBackgroundImageView = itemView.findViewById(R.id.homeListTilecardBackgroundImageView);
